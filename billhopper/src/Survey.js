...
export function SurveyPage() {
    ...
    function onComplete(result) {
        ...
        window.location.href = "/broadband/searching?"+postCodeName+'&'+ssid+'&'+c1+'&'+c2+'&'+c3+'&'+source;
    ...
    <div className="container" style={{backgroundColor: '#f6f6f7'}}>
        ...
        <div className='progressBarValue'>
            <div style={{width:'1%', margin: '0 auto', position: 'relative'}}>
