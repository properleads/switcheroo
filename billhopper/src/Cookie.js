    ...
    <div className="container" >
        ...
        <div style={header}>
            <div style={{padding: "4px",  lineHeight: '54px'}}>
                <span>Cookie Policy for Bill Hopper</span>
            </div>
        </div>
        ...
        <div style={{
            ...
            <div style={content}>
            This is the Cookie Policy for Bill Hopper, accessible from https://Billhopper.co.uk
            </div>
            ...
            <div style={content}>
            By visiting this link: https://Billhopper.co.uk/contact
            </div>
        </div>
    </div>
    );
