                    ...
                    <div>
                        ...
                        <div className='offer_list'>
                            <div className='bottomEn'><img alt='' style={offerCheck}
                                                           src={process.env.PUBLIC_URL + '/images/checkPink.png'}/> Totally
                                Unlimited Broadband
                            </div>
                            <div className='bottomEn'><img alt='' style={offerCheck}
                                                           src={process.env.PUBLIC_URL + '/images/checkPink.png'}/> Award
                                Winning WIFI Hub
                            </div>
                            <div className='bottomEn'><img alt='' style={offerCheck}
                                                           src={process.env.PUBLIC_URL + '/images/checkPink.png'}/> 3.500+
                                5* Trustpilot Reviews
                            </div>
                        </div>

                        <div className='thankButton'>
                            <a className='thankYouLink' href="https://m.me/Switcheroome?ref=w10860760" target="_blank"
