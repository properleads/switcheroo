...
export function HomePage() {
    ...
    <div className="container">
        ...
        <div className='headBox'>
            <div className='postcode' style={{margin: '19px auto'}}>Why use Wifiwizard?</div>
            <div className='wifi_logo'><img src={process.env.PUBLIC_URL + '/images/switch-wifi.png'} alt='wifi' /></div>
            <div className='homeSquare'>
                <div className='squareImg'><img alt='switch calc' src={process.env.PUBLIC_URL + '/images/Homepage-Switch-Calc.png'} /></div>
            ...
            <div className='homeSquare'>
                <div className='squareImg square2'><img alt='switch clock' src={process.env.PUBLIC_URL + '/images/Homepage-Switch-Clock.png'} /></div>
                <div className='squareTxt'>
            ...
            <div className='homeSquare'>
                <div className='squareImg square3'><img alt='switch wifi' src={process.env.PUBLIC_URL + '/images/Homepage-Switch-Wifi.png'} /></div>
                <div className='squareTxt'>
            ...
            <div className='homeSquare'>
                <div className='squareImg square4'><img alt='switch stars' src={process.env.PUBLIC_URL + '/images/Homepage-Switch-Stars.png'} /></div>
                <div className='squareTxt'>
