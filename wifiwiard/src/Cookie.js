    ...
    <div className="container" >
        ...
        <div style={header}>
            <div style={{padding: "4px",  lineHeight: '54px'}}>
                <span>Cookie Policy for Wifiwizard</span>
            </div>
        </div>
        ...
        <div style={{
            ...
            <div style={content}>
            This is the Cookie Policy for Wifiwizard, accessible from https://Wifiwizard.me
            </div>
            ...
            <div style={content}>
            By visiting this link: https://Wifiwizard.co.uk/contact
            </div>
        </div>
    </div>
    );
