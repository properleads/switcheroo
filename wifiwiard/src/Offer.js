...
class NameForm extends React.Component {
    ...
    handleSubmit = (event) => {
        ...
        if(this.state.numberCheck === 'OK') {
            ...
            fetch('https://properleads.leadbyte.co.uk/api/submit.php?campid=BILLHOPPERWEB&returnjson=yes&sid=WIFIWIZARD&postcode=' + this.state.postcode + '&ssid=' + this.state.ssid + '&c1=' + this.state.c1 + '&c2=' + this.state.c2 + '&c3=' + this.state.c3 + '&source=' + this.state.source + '&first_name=' + this.state.first + '&last_name=' + this.state.last + '&email=' + this.state.email + '&gclid=' + this.state.gclid + '&msclkid=' + this.state.msclkid + '&phone_1=' + this.state.phone, {
                method: 'POST',
            ...
            <div id='one' className='offer_container_two'>
                ...
                <div className='offer_container'>
                    ...
                    <div className='offer_tick'>
                        <img alt='' src={process.env.PUBLIC_URL + '/images/check.jpg'}/>
