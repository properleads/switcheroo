    ...
    <div className="container">
        ...
        <div style={top} className="top">
            <div className='providers'>
                <img alt='energy_providers' src={process.env.PUBLIC_URL + '/images/energy_providers.jpg'} style={providersLogo}/>
            </div>
        </div>

        <div style={div}>
            <span style={postcode}>What is your Postcode?</span><br /><br />
        ...
        <div style={divTwo}>
            <span style={postcode}>Select your full address</span><br /><br />
        </div>
