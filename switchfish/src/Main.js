...
export function MainPage() {
        ...
        fetch(gitHubUrl)
            ...
            .then(json => {
                if(json.status === 'ZERO_RESULTS') {
                    ...
                    window.location.href = '/broadband/journey?postcode=' + postCode + '&' + ssid + '&' + c1 + '&' + c2 + '&' + c3 + '&' + source + '&' + client + '&' + ck;
                }
    ...
    <div className="container">
        ...
        <div style={buttondiv}>
                ...
                <input id="post_code_input" minLength="7" maxLength="8" required placeholder="NG12 2AA" className="postCodeInput" onChange={handleChange}
                       onKeyDown={(e) => {
