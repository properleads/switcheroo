...
export function SurveyPage() {
    ...
    if (window.performance && window.performance.navigation.type === 2) {
        //alert('/broadband/journey?postcode=' + postCodeName + '&' + ssid + '&' + source + '&' + client + '&' + ck);
        if(ck_val < 5) {
            window.location.href = '/broadband/journey?postcode=' + postCodeName + '&' + ssid + '&' + source + '&' + client + '&' + ck;
        } else {
    ...
    function onComplete(result) {
        ...
        window.location.href = "/broadband/searching?"+postCodeName+'&'+ssid+'&'+c1+'&'+c2+'&'+c3+'&'+source+'&'+client+'&'+ck+'&'+gclid+'&'+msclkid;
