...
//https://properleads.leadbyte.co.uk/api/submit.php?campid=BILLHOPPERWEB&returnjson=yes
    handleSubmit = (event) => {
        ...
        if(this.state.numberCheck === 'OK') {
            ...
            //https://properleads.leadbyte.co.uk/api/submit.php?returnjson=yes&campid=B-WEB-SWITCHEROO&
            fetch('https://properleads.leadbyte.co.uk/api/submit.php?returnjson=yes&campid=B-WEB-SWITCHEROO&sid=SWITCHFISH&postcode=' + this.state.postcode + '&ssid=' + this.state.ssid + '&c1=' + this.state.c1 + '&c2=' + this.state.c2 + '&c3=' + this.state.c3 + '&source=' + this.state.source + '&first_name=' + this.state.first + '&last_name=' + this.state.last + '&email=' + this.state.email + '&phone_1=' + this.state.phone  + '&gclid=' + this.state.gclid + '&msclkid=' + this.state.msclkid, {
                method: 'POST',
            ...
            setTimeout(() => {
                window.location.href = "/broadband/thank-you";
            }, 500);
        ...
        <div className='offer_divv_bottom'>
            ...
            <form onSubmit={this.handleSubmit} >
                ...
                <div className='offer_input_first'>
                    <input required placeholder="First name" className='offer_Input' type="text" name="first" value={this.state.value} onChange={this.handleChange} />
                </div>
                ...
                <div>
                    <input required placeholder="Last name"  className='offer_Input' type="text" name="last" value={this.state.value} onChange={this.handleChange} />
                </div>
                ...
                <div>
                    <input autoComplete="none" required placeholder="Mobile number"  className='offer_Input' type="tel" name="phone" maxLength="11" minLength="11" value={this.state.value} onChange={this.handleChange} onBlur={ this.numberCheck} />
                </div>
                ...
                <div>
                    <input type="email" required  placeholder="Email address"  className='offer_Input' name="email" value={this.state.value} onChange={this.handleChange} />
                </div>
...
export function OfferPage() {
    ...
    return (
        <div className="container">
            ...
            {(Number(urlParams.cid[0]) === 0 || Number(urlParams.cid[0]) === 1) &&
            ...
            <div id='three' className='offer_container_two'>
                ...
                <div className='offer_container'>
                    ...
                    <div className='price'>&pound;26</div>


                    <div className='offer_tick'>
                        <img alt='' style={offerCheck} src={process.env.PUBLIC_URL + '/images/check.jpg'}/>
                        Avg. speed of <span style={{color: '#9f04c6'}}>67</span> Mb/s
                    </div>
                    <div className='offer_tick'>
                        <img alt='' style={offerCheck} src={process.env.PUBLIC_URL + '/images/check.jpg'}/>
                        No mid-contract price rises
            ...
            <div id='four' className='offer_container_two'>
                ...
                <div className='offer_container'>
                    ...
                    <div className='price'>&pound;32</div>
