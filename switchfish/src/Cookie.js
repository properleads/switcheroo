    ...
    <div className="container" >
        ...
        <div style={header}>
            <div style={{padding: "4px",  lineHeight: '54px'}}>
                <span>Cookie Policy for Switchfish</span>
            </div>
        </div>
        ...
        <div style={{
            ...
            <div style={content}>
            This is the Cookie Policy for Switchfish, accessible from https://switcheroo.me
            </div>
            ...
            <div style={content}>
            By visiting this link: https://switchfish.deals/contact
            </div>
        </div>
    </div>
    );
